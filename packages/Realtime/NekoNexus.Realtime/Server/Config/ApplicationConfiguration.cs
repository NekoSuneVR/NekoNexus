...
namespace NekoNexus.Realtime.Server {
	...
	public class GameplaySettings {
		[YamlMember]
		public int MatchCountdownTime = 5;
		...
		// AI fill bots (BETA, off by default): keep a match populated while few (or no) real players
		// have joined. NOT a YAML setting - admin-controlled and pushed live over the master socket,
		// see GameServerApplication.BotsConfig / BotsConfigState.
	}
}
