...
using NekoNexus.Realtime.Server;
using NekoNexus.WebServices.Contracts;
...
namespace NekoNexus.Realtime {
	public class ShopWebServiceClient : BaseWebServiceClient<IShopWebServiceContract> {
		...
		public ShopWebServiceClient(string masterHostname, int port, string serviceEndpoint, string webServicePrefix, string webServiceSuffix) : base(masterHostname, port, serviceEndpoint, $"{webServicePrefix}ShopWebService{webServiceSuffix}") { }
