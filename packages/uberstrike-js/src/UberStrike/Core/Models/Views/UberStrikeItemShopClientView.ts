...
export default class UberStrikeItemShopClientView {
  FunctionalItems: UberStrikeItemFunctionalView[];
  GearItems: UberStrikeItemGearView[];
  QuickItems: UberStrikeItemQuickView[];
  WeaponItems: UberStrikeItemWeaponView[];
  ItemsRecommendationPerMap: { [key: number]: number }; // # LEGACY # //

  constructor(params: Partial<UberStrikeItemShopClientView> = {}) {
