...
namespace NekoNexus.Client {
	public class NekoNexusPopupDialog : IPopupDialog {
		...
		public NekoNexusPopupDialog(string title, string text, PopupSystem.AlertType flag, string okCaption, Action ok, string cancelCaption, Action cancel, string auxCaption, Action aux) {
			Text = text;
			Title = title;
			_alertType = flag;
		...
		public NekoNexusPopupDialog(string title, string text) : this(title, text, PopupSystem.AlertType.None, string.Empty, null, String.Empty, null, String.Empty, null) { }
