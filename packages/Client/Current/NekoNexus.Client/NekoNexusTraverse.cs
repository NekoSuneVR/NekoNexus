...
namespace NekoNexus.Client {
	public class NekoNexusTraverse<T> {
		public T Instance;
		protected readonly Traverse traverse;

		public NekoNexusTraverse(Type type) {
			traverse = Traverse.Create(type);
		}

		public NekoNexusTraverse(T instance) {
			traverse = Traverse.Create(instance);
			Instance = instance;
		}

		public static NekoNexusTraverse<T> Create() {
			return new NekoNexusTraverse<T>(typeof(T));
		}

		public static NekoNexusTraverse<T> Create(T instance) {
			return new NekoNexusTraverse<T>(instance);
		}
	...
	public class NekoNexusTraverse : NekoNexusTraverse<object> {
		public NekoNexusTraverse(Type type) : base(type) { }
		public NekoNexusTraverse(object instance) : base(instance) { }

		public static NekoNexusTraverse Create(Type type) {
			return new NekoNexusTraverse(type);
		}

		public static new NekoNexusTraverse Create(object instance) {
			return new NekoNexusTraverse(instance);
		}
	}
}
