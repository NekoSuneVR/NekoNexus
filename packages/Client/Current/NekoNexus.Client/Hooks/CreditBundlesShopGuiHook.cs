...
namespace NekoNexus.Client {
	...
	/// renders Steam micro-transaction bundles that don't exist on a NekoNexus server, which throws
	/// every frame and freezes the UI ("unclickable"). Replace its drawing with a simple panel that
	/// opens the NekoNexus web store (NekoPay) in the browser.
	/// </summary>
	...
	public static class CreditBundlesShopGuiHook {
		public static bool Prefix(Rect position) {
			GUI.Label(
				...
				"Get credits on the NekoNexus web store",
