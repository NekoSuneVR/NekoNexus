...
namespace NekoNexus.Client {
	...
	public static class StatsPageGUIHook {
		private static NekoNexusTraverse<StatsPageGUI> traverse;

		[HarmonyPatch("Awake"), HarmonyPrefix]
		public static bool Awake_Postfix(StatsPageGUI __instance) {
			if (traverse == null) {
				traverse = NekoNexusTraverse<StatsPageGUI>.Create(__instance);
			}
		...
		public static void Start_Postfix(StatsPageGUI __instance) {
			traverse.SetField("_weaponIcons", new Dictionary<string, Texture2D> {
				...
				[NekoNexusLocalizedStrings.Handguns] = ShopIcons.StatsMostWeaponSplatsHandgun,
		...
		public static bool DrawPersonalStatsTab(Rect rect) {
			...
			traverse.InvokeMethod("DrawPersonalStat", 36, 669, num, NekoNexusLocalizedStrings.MostHandgunKills, personalRecord.GetProps().MostHandgunSplats.ToString(), ShopIcons.StatsMostWeaponSplatsHandgun);
		...
		public static bool UpdateWeaponStatList_Prefix() {
			...
			switch (_selectedFilterIndex) {
				case 0:
					...
					_weaponStatList.Add(weaponStatistics.GetProps().HandgunTotalDamageDone, NekoNexusLocalizedStrings.Handguns);
				...
				case 1:
					...
					_weaponStatList.Add(weaponStatistics.GetProps().HandgunTotalSplats, NekoNexusLocalizedStrings.Handguns);
				...
				case 2:
					...
					_weaponStatList.Add((weaponStatistics.GetProps().HandgunTotalShotsHit != 0) ? (Mathf.Clamp01(weaponStatistics.GetProps().HandgunTotalShotsHit / weaponStatistics.GetProps().HandgunTotalShotsFired) * 100f) : 0f, NekoNexusLocalizedStrings.Handguns);
				...
				case 3:
					...
					_weaponStatList.Add(weaponStatistics.GetProps().HandgunTotalShotsHit, NekoNexusLocalizedStrings.Handguns);
