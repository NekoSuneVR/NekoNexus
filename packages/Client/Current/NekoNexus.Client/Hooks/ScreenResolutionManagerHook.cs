...
#pragma warning restore IDE1006
	...
	public static class ScreenResolutionManagerHook {
		[HarmonyPrepare]
		public static void Prepare() {
			XmlSerializer serializer = new XmlSerializer(typeof(ScreenResolutionOptions));
			using (Stream stream = Assembly.GetAssembly(typeof(NekoNexusClient)).GetManifestResourceStream("NekoNexus.Client.ScreenResolutions.xml")) {
