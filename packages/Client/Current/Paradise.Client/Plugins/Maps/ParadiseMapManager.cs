...
namespace Paradise.Client {
	internal class ParadiseMapManager {
		private static readonly ILog Log = LogManager.GetLogger(nameof(ParadiseMapManager));
		...
		public static bool LoadMaps(List<ParadiseMapView> maps) {
			Maps.Clear();
			Maps.AddRange(maps);
