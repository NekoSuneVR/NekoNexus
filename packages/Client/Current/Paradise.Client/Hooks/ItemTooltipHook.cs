				...
				case UberstrikeItemClass.WeaponSniperRifle: {
					...
					if (item.View is UberStrikeItemWeaponView uberStrikeItemWeaponView2) {
						...
						if (item.View.ItemProperties.ContainsKey(ItemPropertyType.CritDamageBonus)) {
							ParadiseTraverse.SetField(__instance, "_criticalHit", item.View.ItemProperties[ItemPropertyType.CritDamageBonus]);
						} else if (uberStrikeItemWeaponView2.CriticalStrikeBonus > 0) {
							ParadiseTraverse.SetField(__instance, "_criticalHit", uberStrikeItemWeaponView2.CriticalStrikeBonus);
						} else {
							ParadiseTraverse.SetField(__instance, "_criticalHit", 0);
						}
					}
