...
namespace NekoNexus.Client.Bootstrap {
	public static class Bootstrapper {
		public static void Initialize() {
			...
			NekoNexusClient.Initialize();

			var harmonyInstance = new Harmony("tf.festival.NekoNexus");
			harmonyInstance.PatchAll(Assembly.GetAssembly(typeof(NekoNexusClient)));
