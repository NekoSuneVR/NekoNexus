...
OutFile "..\..\.release\client\Paradise-client-win-x86.exe"
...
Section "Paradise Runtime" ParadiseRuntime
	...
	SetOutPath "$INSTDIR"
	File "/oname=uberdaemon_paradise.exe" "..\..\.release\client\_pak\uberdaemon_paradise.exe"
...
Section "Patch UberStrike" UberStrikePatch
	...
	File "..\..\.release\client\_pak\UberStrike_Data\Paradise.Patch.xml"
