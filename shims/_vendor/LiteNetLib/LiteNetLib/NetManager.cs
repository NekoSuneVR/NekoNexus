...
namespace LiteNetLib
{
    ...
    public class NetManager : IEnumerable<NetPeer>
    {
        ...
        public NetManager(INetEventListener listener, PacketLayerBase extraPacketLayer = null)
        {
            ...
            // Paradise patch: do NOT eagerly create the NAT-punch module. Its NetSerializer
            // pulls in System.Runtime.Serialization v3, which Unity's Mono lacks, crashing
            // PhotonPeer construction on the game client. We never use NAT punchthrough, and
            // its only usage is guarded by NatPunchEnabled (false), so leaving it null is safe.
